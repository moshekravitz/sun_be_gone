...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget build(BuildContext context) {
    String directionButtonText = AppLocalizations.of(context)!.directionButton;
    String linesButtonText = AppLocalizations.of(context)!.linesButton;
    String notFoundText = AppLocalizations.of(context)!.notFound;
        ...
        children: [
          ...
          Expanded(
            child: BlocConsumer<BusRotuesBloc, BusRoutesState>(
              ...
              if (state.busRoutes.isEmpty) Text(notFoundText);
