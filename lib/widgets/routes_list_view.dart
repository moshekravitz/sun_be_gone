...
class _RoutesListViewState extends State<RoutesListView> {
  ...
  Widget build(BuildContext context) {
    final appLocle = AppLocalizations.of(context)!;
    final String sliderTitle =
        widget.isFavoritsList ? appLocle.addToFavorites : appLocle.removeFromFavorites;
                      ...
                      endActionPane: ActionPane(
                        ...
                        children: [
                          SlidableAction(
                            ...
                            backgroundColor: widget.isFavoritsList
                                ? Colors.red
                                : Colors.blue,
                      ...
                      child: GestureDetector(
                        ...
                        onTap: () {
                          return widget.onRoutePicked(
                              widget.routes.elementAt(index)!, widget.dateTime);
                        },
                      ),
                      /*child: ListTile(
